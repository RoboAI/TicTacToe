...
import static com.example.tictactoe.GlobalDefines.CLIENT_PROTOCOL_STAGES;
import static com.example.tictactoe.GlobalDefines.DEFAULT_BC_PORT;
import static com.example.tictactoe.GlobalDefines.DEFAULT_MASTER_PORT;
import static com.example.tictactoe.GlobalDefines.SERVER_PROTOCOL_STAGES;
...
public class NDServer implements Runnable{
    ...
    com.example.tictactoe.UDPSocket serverListener;
    Thread thread;
    ...
    public boolean startServer(){
        ...
        serverListener = new com.example.tictactoe.UDPSocket(portToListen, "0.0.0.0");
        serverListener.bind();
    ...
    public void run() {
        ...
        try {
            ...
            while (iExit == 0) {
                ...
                com.example.tictactoe.UDPSocket.UDPExtracted ue = serverListener.new UDPExtracted();
                String data = null;
    ...
    private void sendResponseAvailable(com.example.tictactoe.UDPSocket.UDPExtracted ue) {
    ...
    private String getUDPData(com.example.tictactoe.UDPSocket.UDPExtracted out) throws IOException{
        Log.i(TAG, "NDServer:getUDPData(): Receiving UDP Packet");

        com.example.tictactoe.UDPSocket.UDPExtracted udpe = receiveUDPPacket();
    ...
    private com.example.tictactoe.UDPSocket.UDPExtracted receiveUDPPacket() throws IOException {
