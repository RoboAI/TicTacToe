...
import static com.example.fuat.newtictactoe.GlobalDefines.DEFAULT_UDP_PORT;
import static com.example.fuat.newtictactoe.GlobalDefines.TAG;
import static com.example.fuat.newtictactoe.GlobalDefines.globalMyIP;
...
public class NDClient implements Runnable {
    ...
    com.example.fuat.newtictactoe.UDPSocket socket;
    Thread thread;
    ...
    public void startClient(){
        ...
        socket = new com.example.fuat.newtictactoe.UDPSocket(DEFAULT_UDP_PORT, connectIP);
